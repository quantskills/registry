...
As of 2026-07-19: **78 skills / 6 agents**. Categories: `Uncategorized / uncategorized` 22 · `Tooling / tooling` 15 · `Factor Library / factor` 13 · `Analyst / analyst` 12 · `Monitor / monitor` 6 · `Trader Research / trader-research` 4 · `Data API / data-api` 3 · `Replication / replication` 3 · `Monitor Agent / monitor-agent` 2 · `Research Agent / research-agent` 1 · `Risk Agent / risk-agent` 1 · `Workflow Agent / workflow-agent` 1 · `finance-news / finance-news` 1; validation levels L3 ×10 · L2 ×25 · L1 ×44 · documentation ×1 · production ×3 · rules-only ×1.
