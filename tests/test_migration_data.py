...
class MigrationDataTests(unittest.TestCase):
 def write(self, root, mutate=lambda rows,audit,waves: None):
  ...
  rows=[]; stage=[('data-ingestion','01','01.data-source-connectors'),('data-quality','01','01.warehouse-cache'),('feature-engineering','02','02.factor-generation'),('factor-generation','02','02.factor-generation'),('factor-screening','02','02.factor-screening'),('modeling','06','06.statistical-ml-models'),('portfolio-construction','05','05.portfolio-construction'),('backtesting','05','05.backtest-engine'),('evaluation','02','02.factor-evaluation'),('risk','04','04.market-regime'),('monitoring','04','04.market-regime'),('execution','05','05.paper-live-execution'),('reporting','08','08.daily-review'),('orchestration','09','09.workflow-orchestration-agent')]
