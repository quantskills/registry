...
As of 2026-06-27: **36 skills / 5 agents**. Categories: `Tooling / tooling` 12 · `Factor Library / factor` 10 · `Analyst / analyst` 7 · `Monitor / monitor` 3 · `Data API / data-api` 2 · `Replication / replication` 2 · `Monitor Agent / monitor-agent` 2 · `Research Agent / research-agent` 1 · `Risk Agent / risk-agent` 1 · `Workflow Agent / workflow-agent` 1; validation levels L3 ×9 · L2 ×19 · L1 ×10 · production ×3.
