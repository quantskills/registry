...
As of 2026-07-03: **38 skills / 7 agents**. Categories: `Tooling / tooling` 12 · `Factor Library / factor` 10 · `Analyst / analyst` 7 · `Monitor / monitor` 3 · `Replication / replication` 3 · `Data API / data-api` 2 · `Monitor Agent / monitor-agent` 2 · `Workflow Agent / workflow-agent` 2 · `Uncategorized / uncategorized` 2 · `Research Agent / research-agent` 1 · `Risk Agent / risk-agent` 1; validation levels L3 ×9 · L2 ×21 · L1 ×12 · production ×3.
