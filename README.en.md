...
As of 2026-06-15: **28 skills / 5 agents**. Categories: `Tooling / tooling` 10 · `Analyst / analyst` 7 · `Factor Library / factor` 3 · `Monitor / monitor` 3 · `Replication / replication` 3 · `Data API / data-api` 2 · `Monitor Agent / monitor-agent` 2 · `Research Agent / research-agent` 1 · `Risk Agent / risk-agent` 1 · `Workflow Agent / workflow-agent` 1; validation levels L3 ×7 · L2 ×18 · L1 ×8.
