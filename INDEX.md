...
| [skill-xingtai-catcher](https://github.com/quantskills/skill-xingtai-catcher) | 按文字、K线截图或手绘图查找相似股票和期货形态，支持无 MCP 直连脚本。 | L2 Runnable | active | `a-share` `futures` `kline-pattern` `mcp` `pattern-search` |
