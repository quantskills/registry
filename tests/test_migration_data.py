...
class MigrationDataTests(unittest.TestCase):
 ...
 def test_positive_and_negatives(self):
  cases=[lambda r,a,w:r.__setitem__(1,r[0]),lambda r,a,w:r[0].update(workflow_stages='risk|data-ingestion'),lambda r,a,w:a.update(inventory_sha256='bad'),lambda r,a,w:a['items'][0].update(candidate_mode='bad')]
  with tempfile.TemporaryDirectory() as d:
   ...
   args=self.write(p,lambda r,a,w:r[0].update(review_status='blocked')); validate(*args); self.assertRaises(ValueError,validate,*args,True)
