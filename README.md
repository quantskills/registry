...
截至 2026-06-27：**36 个 skill / 5 个 agent**。分类分布：`工具流程类 / tooling` 12 · `因子库 / factor` 10 · `分析类 / analyst` 7 · `监控类 / monitor` 3 · `数据类 / data-api` 2 · `复现类 / replication` 2 · `监控 Agent / monitor-agent` 2 · `研究 Agent / research-agent` 1 · `风险 Agent / risk-agent` 1 · `工作流 Agent / workflow-agent` 1；验证级别 L3 ×9 · L2 ×19 · L1 ×10 · production ×3。
