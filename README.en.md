...
As of 2026-07-05: **44 skills / 7 agents**. Categories: `Tooling / tooling` 12 · `Factor Library / factor` 10 · `Analyst / analyst` 9 · `Uncategorized / uncategorized` 5 · `Monitor / monitor` 4 · `Replication / replication` 3 · `Data API / data-api` 2 · `Monitor Agent / monitor-agent` 2 · `Workflow Agent / workflow-agent` 2 · `Research Agent / research-agent` 1 · `Risk Agent / risk-agent` 1; validation levels L3 ×9 · L2 ×22 · L1 ×15 · documentation ×1 · production ×3 · rules-only ×1.
