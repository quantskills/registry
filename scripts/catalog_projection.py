...
PUBLIC_FIELDS = ("name", "url", "description", "project_type", "declaration_file", "tags", "platforms", "status", "requires", "summary_zh", "summary_en", "license", "validation_level", "maintainer_type", "last_validated", "commit_sha")
