...
<p align="center">
  <img alt="public assets" src="https://img.shields.io/badge/public_assets-97_skills_6_agents-blue">
...
flowchart LR
    ...
    D --> E{"Health grading"}
    E -->|"healthy / warning"| F["📦 catalog outputs<br/>catalog.snapshot.json · registry.json<br/>INDEX.md · llms.txt · marketplace.json"]
...
**Required `quantSkills` fields** follow Catalog Contract v2 (`schema_version: 2.0.0`):

| Field | Constraint |
|---|---|
| `catalog` / `workflow` | One taxonomy category/subcategory and valid primary/workflow stages; see the [Catalog Contract](docs/CATALOG_CONTRACT_en.md) |
...
As of 2026-07-22: **97 skills / 6 agents**. Categories: `Uncategorized / uncategorized` 23 · `Analyst / analyst` 20 · `Tooling / tooling` 19 · `Factor Library / factor` 13 · `Monitor / monitor` 12 · `Trader Research / trader-research` 4 · `Data API / data-api` 3 · `Replication / replication` 3 · `Monitor Agent / monitor-agent` 2 · `Research Agent / research-agent` 1 · `Risk Agent / risk-agent` 1 · `Workflow Agent / workflow-agent` 1 · `finance-news / finance-news` 1; validation levels L3 ×10 · L2 ×43 · L1 ×45 · documentation ×1 · production ×3 · rules-only ×1.
