...
As of 2026-07-15: **62 skills / 7 agents**. Categories: `Tooling / tooling` 15 · `Factor Library / factor` 12 · `Analyst / analyst` 11 · `Uncategorized / uncategorized` 8 · `Monitor / monitor` 6 · `Trader Research / trader-research` 4 · `Data API / data-api` 3 · `Replication / replication` 3 · `Monitor Agent / monitor-agent` 2 · `Workflow Agent / workflow-agent` 2 · `Research Agent / research-agent` 1 · `Risk Agent / risk-agent` 1 · `finance-news / finance-news` 1; validation levels L3 ×9 · L2 ×25 · L1 ×30 · documentation ×1 · production ×3 · rules-only ×1.
